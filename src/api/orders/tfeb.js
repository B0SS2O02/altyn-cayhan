...
const registerTFEB = async (transactionId, amount) => {
    try {
        ...
        data_bank.environment.transport.merchantFinalResponseUrl = "http://localhost:8880/api/v1/order/payment/callback-handler-tfeb"
        data_bank.environment.transport.challengeResponseUrl = "http://localhost:8880/api/v1/order/payment/callback-handler-tfeb"
        ...
        if (secResponse.data.response.operationResult == VneshBankStatuses.NOPAYMENT) {
            return {
                ...
                finalUrl: "http://localhost:8880/api/v1/order/payment/callback-handler-tfeb/" + secResponse.data.response.orderId,
                checkOrder: "http://localhost:8880/api/v1/order/payment/check-status-tfeb?orderId=" + secResponse.data.response.orderId
            }
        }
