...
const locales = {
  tm: {
    ...
    "Pikir": "Pikir",
    "Categories are division of restaurant foods. Here you can manage them.": "Kategoriýalar restoran naharlarynyp bölünme toparydyr we ony dolandyryp bilersiňiz.",
    "Foods are main products of restaurant and each food has own categories.": "Naharlar restoranyň esasy harydy bolup her bir naharyň özüne degişli kategoriýasy bardyr.",
    "When it comes to ordering food, it's like stepping into a doorway that leads to a world of culinary delights. It's an experience that tantalizes your taste buds, stirs your senses, and satisfies both hunger and cravings.": "Iýmit sargyt etmek barada aýdylanda, aşpez lezzetleri dünýäsine alyp barýan gapydan giren ýaly. Bu, tagamyňyzy güýçlendirýän, duýgyňyzy güýçlendirýän we açlygy we islegleri kanagatlandyrýan tejribe.",
  ...
  ru: {
    ...
    "Categories are division of restaurant foods. Here you can manage them.": "Категории - это разделение ресторанных блюд. Здесь вы можете управлять ими.",
    "Foods are main products of restaurant and each food has own categories.": "Блюда - это основная продукция ресторана, и каждая еда имеет свои категории.",
    "When it comes to ordering food, it's like stepping into a doorway that leads to a world of culinary delights. It's an experience that tantalizes your taste buds, stirs your senses, and satisfies both hunger and cravings.": "Когда дело доходит до заказа еды, это все равно, что войти в дверь, ведущую в мир кулинарных изысков. Это опыт, который дразнит ваши вкусовые рецепторы, возбуждает ваши чувства и утоляет голод и тягу.",
